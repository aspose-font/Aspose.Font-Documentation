...
To see what functional for working with glyphs you can get from using it, have a look at [*Glyphs namespace*](https://apireference.aspose.com/font/cpp/aspose.font.glyphs) of [*Aspose.Font for C++*](https://apireference.aspose.com/font/cpp) library.
